...
/**
 * UF11 Exercici B7: Programa que llig un document de text i mostra per pantalla
 * algunes dades
 * estadístiques: núm. de línies, núm. de paraules, núm. de caràcters i quines
 * són les 10 paraules més
 * comunes (i quantes vegades apareixen). Prova el programa amb els arxius de la
 * carpeta ‘Llibres’.
 */
public class MostraEstadistiquesLlibres {
