...
/**
 * UF11 Exercici B4: Programa que genera aleatòriament noms de persona
 * (combinant noms i cognoms
 * de ‘usa_noms.txt’ i ‘usa_cognoms.txt’). Se li demanarà a l'usuari quants noms
 * de persona desitja
...
public class NomsPersones {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ArrayList<String> llistaNoms = llegirDadesArxiu(fileNoms);
            ArrayList<String> llistaCognoms = llegirDadesArxiu(fileCognoms);
    ...
    public static ArrayList<String> llegirDadesArxiu(File f) throws FileNotFoundException {
