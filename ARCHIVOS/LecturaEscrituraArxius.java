...
/**
 * UF11 Exercici B3: Programa que demana a l'usuari un nom d'arxiu A per a
 * lectura i un altre nom d'arxiu
 * per a escriptura. Llegirà el contingut de l'arxiu A (per exemple
 * ‘usa_persones.txt’) i ho escriurà
 * ordenat alfabèticament en B (per exemple ‘usa_persones_sorted.txt’).
 */
public class LecturaEscrituraArxius {
