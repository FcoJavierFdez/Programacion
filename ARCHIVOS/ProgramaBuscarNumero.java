...
/**
 * UF11 Exercici B6: Programa que demana a l'usuari un número de qualsevol
 * longitud, com per exemple
 * “1234”, i li diu a l'usuari si aquest número apareix en el primer milió de
 * decimals del núm. pi (estan
 * en l'arxiu ‘pi-million.txt’). No està permés utilitzar cap llibreria ni
 * classe ni mètode que realitze la
 * cerca. Has d'implementar l'algorisme de cerca tu mateix.
 */
public class ProgramaBuscarNumero {
